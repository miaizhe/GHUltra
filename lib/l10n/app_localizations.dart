...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'private': 'Private',
      'private_desc': 'Only you can see this repository.',
      'init_readme': 'Initialize with README',
      'cancel': 'Cancel',
      'create': 'Create',
      'name_cannot_be_empty': 'Name cannot be empty',
      'repo_created_success': 'Repository created successfully!',
      'view': 'View',
    },
    'zh': {
      'repositories': '仓库',
      ...
      'private': '私有',
      'private_desc': '只有你能看到这个仓库。',
      'init_readme': '使用 README 初始化',
      'cancel': '取消',
      'create': '创建',
      'name_cannot_be_empty': '名称不能为空',
      'repo_created_success': '仓库创建成功！',
      'view': '查看',
    },
  };
